...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "henrikvtcodes"
    user-mail-address "commits@henrikvt.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/henrikvt/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/henrikvt/bin" "/profile/bin" "/Users/henrikvt/.npm-packages/bin" "/Users/henrikvt/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
